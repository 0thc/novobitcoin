...
###   This script attempts to download the signature file SHA256SUMS.asc from novobitcoin.org.
...
RCSUBDIR="test"
HOST1="https://download.novobitcoin.org"
BASEDIR="/novobitcoin/"
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Novo Bitcoin binary release signing key installed?"
   fi
