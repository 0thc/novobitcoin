 ...
 * them to be valid.
 * In the future other flags may be added, such as a soft-fork to enforce
 * strict DER encoding.
 *
...
/*
 * Extract a single destination from P2PK, P2PKH
 */
bool ExtractDestination(const CScript &scriptPubKey, CTxDestination &addressRet);
/**
 * Extracts all destinations from the script. P2PK, P2PKH and MULTISIG.
 */
