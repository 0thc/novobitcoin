...
bool Solver(const CScript &scriptPubKey,
    ...
    int offset = 0;
    //check if starts with OP_FALSE, OP_RETURN
        ...
        while (true) {
            if (pc1 == script1.end() && pc2 == script2.end()) {
                ...
                if (typeRet == TX_MULTISIG) {
                    ...
                    if (!novo::IsMinimallyEncoded(vSolutionsRet.front(), CScriptNum::MAXIMUM_ELEMENT_SIZE) ||
                        !novo::IsMinimallyEncoded(vSolutionsRet.back(), CScriptNum::MAXIMUM_ELEMENT_SIZE)){
                        typeRet = TX_NONSTANDARD;
                        return false;
                    }
