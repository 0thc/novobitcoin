...
static const Amount COIN(10000);
static const Amount CENT(100);
 ...
 *
 * Note that this constant is *not* the total money supply, which in Novo Bitcoin
 * currently happens to be less than 840,000,000,000 NBC for various reasons, but
 * rather a sanity check. As this sanity check is used by consensus-critical
 * validation code, the exact value of the MAX_MONEY constant is consensus
 * critical; in unusual circumstances like a(nother) overflow bug that allowed
 * for the creation of coins out of thin air modification could lead to a fork.
 */
static const Amount MAX_MONEY = 840000000000 * COIN;
