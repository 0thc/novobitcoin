...
public:
    ...
    Amount GetDustThreshold(const CFeeRate &minRelayTxFee, int64_t dustLimitFactor) const {
        /**
    ...
    bool IsDust(const CFeeRate &minRelayTxFee, int64_t dustLimitFactor) const {
        return (nValue < GetDustThreshold(minRelayTxFee, dustLimitFactor));
    }
