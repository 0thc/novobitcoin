...
BOOST_FIXTURE_TEST_CASE(coin_get_lazy, TestingSetup) {
...

    {
...

        {
            ...
            span.AddCoin(COutPoint(txId, 0), CoinWithScript::MakeOwning(std::move(txo), blockHeight, false), false);
        }

        {
            ...
            span.AddCoin(COutPoint(txId, 1), CoinWithScript::MakeOwning(std::move(txo), blockHeight, false), false);
        }
