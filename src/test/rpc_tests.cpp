...
BOOST_AUTO_TEST_CASE(rpc_getinfo)
{
    ...
    BOOST_CHECK_EQUAL(find_value(r.get_obj(), "maxminedblocksize").get_int64(), Params().GetDefaultBlockSizeParams().maxGeneratedBlockSize);
}
...
BOOST_AUTO_TEST_CASE(rpc_rawsign) {
    UniValue r;
    std::string prevout = "[{\"txid\":\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\",\"vout\":1,"
        "\"scriptPubKey\":\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae\","
        "\"amount\":3.1416,\"redeemScript\":\"\"}]";
...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values) {
    BOOST_CHECK(ValueFromAmount(Amount(0LL)).write() == "0.0000");
    BOOST_CHECK(ValueFromAmount(Amount(1LL)).write() == "0.0001");
    BOOST_CHECK(ValueFromAmount(Amount(17622195LL)).write() == "1762.2195");
    BOOST_CHECK(ValueFromAmount(Amount(50000000LL)).write() == "5000.0000");
    BOOST_CHECK(ValueFromAmount(Amount(89898989LL)).write() == "8989.8989");
    BOOST_CHECK(ValueFromAmount(Amount(100000000LL)).write() == "10000.0000");
    BOOST_CHECK(ValueFromAmount(Amount(2099999999999990LL)).write() ==
                "209999999999.9990");
    BOOST_CHECK(ValueFromAmount(Amount(2099999999999999LL)).write() ==
                "209999999999.9999");

    BOOST_CHECK_EQUAL(ValueFromAmount(Amount(0)).write(), "0.0000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values) {
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.19e-2")), Amount(19));
