...
static constexpr Amount DEFAULT_MIN_RELAY_TX_FEE(8000);
//! -maxtxfee default
static const Amount DEFAULT_TRANSACTION_MAXFEE(1000 * COIN);
...
static const uint64_t DEFAULT_SECONDARY_MEMPOOL_ANCESTOR_LIMIT = 10000;
...
static const int64_t DEFAULT_MAX_TIP_AGE = 24 * 60 * 60 * 15;
...
bool GetTransaction(const Config &config, const TxId &txid, CTransactionRef &tx,
    bool fAllowSlow, uint256 &hashBlock);
