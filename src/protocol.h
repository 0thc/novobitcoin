...
enum ServiceFlags : uint64_t {
    ...
    // It is currently set by all Novo Bitcoin nodes, and is unset by SPV clients
    ...
    // protocol request. Novo Bitcoin does not support this but a patch set
    ...
    // connections. Novo Bitcoin nodes used to support this by default, without
