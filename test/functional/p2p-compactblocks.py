...
# TestNode: A peer we use to send messages to novobitcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes novobitcoind to (reasonably!) disconnect us, so do
    # this last.
    ...
    # novobitcoind's choice of nonce.
    ...
    # Test that novobitcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for novobitcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # novobitcoind will not send blocktxn responses for blocks whose height is
