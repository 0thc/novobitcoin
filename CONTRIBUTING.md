# Contributing to Novo Bitcoin

The Novo Bitcoin project welcomes contributors!
...
To get in contact with the Novo Bitcoin project, we monitor a number
of resources.

Our main development repository is currently located at

[https://github.com/novobitcoin/novobitcoin](https://github.com/novobitcoin/novobitcoin)
...
Our main forum is at <https://forum.novobitcoin.org>, where we conduct
our main development for users of our node.

Other social media resources such as our Telegram and Twitter are linked
from the project website at

[https://novobitcoin.org](https://novobitcoin.org)

We seek to facilitate development of Novo Bitcoin,
and to welcome and support people who wish to participate.

Please visit our Github to

- Introduce yourself to other Novo Bitcoin contributors
...
## Novo Bitcoin Development Philosophy

Novo Bitcoin aims for fast iteration and continuous integration.
...
Here are some handy links for development practices aligned with Novo Bitcoin:
...
## Getting set up with the Novo Bitcoin Repository
...
5. Create a personal fork of the Novo Bitcoin repository for your work

    - Sign into GitHub under your account, then visit the project at [https://github.com/novobitcoin/novobitcoin](https://github.com/novobitcoin/novobitcoin)
...
6. Clone your personal work repository to your local machine:
    ...
    ```
    git clone git@github.com:username/novobitcoin.git
    ```

7. Set your checked out copy's upstream to our main project:

    ```
    git remote add upstream https://github.com/novobitcoin/novobitcoin.git
    ```
...
8. Code formatting tools
    ...
    To enforce Novo Bitcoin codeformatting standards, you may need to
...
9. Further task-specific dependencies
...
## Working with The Novo Bitcoin Repository
...
to start is the list of issues at [https://github.com/novobitcoin/novobitcoin/issues](https://github.com/novobitcoin/novobitcoin/issues)
