...
These are the dependencies currently used by Novo Bitcoin. You can find
...
| Boost | [1.59.0](http://www.boost.org/users/download/) | 1.58.0 | No |  |  |  Utility          | Library for threading, data structures, etc
