...
The Novo Bitcoin daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Novo Bitcoin requires ZeroMQ API version 4.3.2 or
...
introduced into Novo Bitcoin directly. Furthermore, no information is
...
using. Novo Bitcoin appends an up-counting sequence number to each
